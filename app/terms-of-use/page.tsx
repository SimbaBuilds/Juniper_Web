            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    <strong>Supported Services:</strong> Notion, Slack, Todoist, Perplexity, Google Workspace, Microsoft Office 365, Sendgrid, and others as specified in the application.
                  </p>
                </section>
