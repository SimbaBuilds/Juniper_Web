...
export function EnhancedTagSelector({ 
  ...
  const dropdownContent = isOpen && (
    <>
      ...
      {/* Dropdown */}
      <div 
        className="fixed z-[101] bg-background border border-border rounded-md shadow-xl overflow-hidden flex flex-col"
        style={{ 
          top: `${dropdownPosition.top}px`, 
          left: `${dropdownPosition.left}px`,
          width: `${dropdownPosition.width}px`,
          maxHeight: 'min(24rem, calc(100vh - ' + (dropdownPosition.top + 20) + 'px))'
        }}
      >
